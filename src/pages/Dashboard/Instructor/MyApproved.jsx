    ...
    return (
        <div>
            <div className='my-9'>
                ...
                <p className='mt-5 text-center text-gray-600'>Here you will find all your approved classes.</p>
            </div>

            <div>
                {
                    approvedClasses.length === 0 ? <div className='text-center text-2xl font-bold mt-10'>You Don't Have Any Approved Classes Yet</div>
                    : <div>
...
export default MyApprovedClasses;
