...
const MyPendingClasses = () => {
    ...
    return (
        <div>
            <div className='my-9'>
                <h1 className='text-4xl font-bold text-center'>My <span className='text-secondary'>Pending Classes</span></h1>
                <p className='mt-5 text-center text-gray-600'>Here you will find all your pending classes.</p>
            </div>

            <div>
                {
                    pendingClasses.length === 0 ? <div className='text-center text-2xl font-bold mt-10'>You Don't Have Any Pending Classes Yet</div>
                    : <div>
...
export default MyPendingClasses;